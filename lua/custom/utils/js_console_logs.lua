function JS_console_log_blank()
  ...
  vim.api.nvim_win_set_cursor(0, { currentLineNumber + 1, 13 })
...
vim.api.nvim_set_keymap('n', '<M-l>', '<cmd>lua JS_console_log_from_yank_register()<cr>', {})
...
vim.api.nvim_set_keymap('n', '<M-j>', '<cmd>lua JS_console_log_JSON_from_yank_register()<cr>', {})
