...
require('lazy').setup({
    ...
    config = function()
      ...
      require('telescope').setup {
        ...
        extensions = {
          ...
          recent_files = {
            -- ['path_display'] = { 'tail' },
            ['path_display'] = { ['shorten'] = { len = 5, exclude = { -3, -2, -1 } } },
            ['initial_mode'] = 'normal',
      ...
      vim.keymap.set('n', '<Leader><leader>', '<cmd>Telescope recent_files<CR>', { desc = 'Recent Files', noremap = true, silent = true })
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          map('E', vim.diagnostic.open_float, 'Show [E]rror in floating window')
  ...
  { -- Highlight, edit, and navigate code
    ...
    opts = {
      ensure_installed = { 'bash', 'c', 'diff', 'html', 'lua', 'luadoc', 'markdown', 'markdownlint', 'markdown_inline', 'query', 'vim', 'vimdoc' },
  ...
  ui = {
    ...
    -- default l= azy.nvim defined Nerd Font icons, otherwise define a unicode icons table
